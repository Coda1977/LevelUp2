    ...
    <div className="bg-[var(--bg-primary)]">
      ...
      <section className="py-20 md:py-32 px-5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button
            ...
            className="bg-[var(--text-primary)] text-[var(--bg-primary)] px-12 py-4 rounded-full font-semibold text-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
          >
            Get Started
          </Button>
        </div>
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-5">
          <h2 className="section-header text-center mb-16">Learn What Matters</h2>
      ...
      <section className="py-20 md:py-32 bg-[var(--bg-primary)]">
        <div className="max-w-6xl mx-auto px-5">
          <h2 className="section-header text-center mb-16">Simple by Design</h2>
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-32 bg-[var(--accent-blue)] text-white">
        <div className="max-w-4xl mx-auto px-5 text-center">
          <h2 className="section-header mb-12 text-white">
            Action Does Not Predict Happiness, But There Is No Happiness Without Action
          </h2>
          <Button
            onClick={() => window.location.href = "/api/login"}
            className="bg-[var(--accent-yellow)] text-[var(--text-primary)] px-12 py-4 rounded-full font-bold text-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
          >
            Begin Your Journey
          </Button>
        </div>
